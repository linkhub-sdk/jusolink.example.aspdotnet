<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="Jusolink.Example.Example.search" %>
			...
			<fieldset class="fieldset1">
				<legend>주소찾기</legend>
					<div class ="fieldset4">
						...
						<a href=javascript:openNewWindow("zipcode_search.aspx")><p class="find_btn find_btn01 hand">주소찾기</p></a>
